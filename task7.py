...
tiny_yolo_graph_file="/home/pi/Desktop/9lab_t1_t4/ESAP9/yolo/graph" #TODO: Assign this to the name of the pretrained yolo graph file. 
...
#    display_image = source_image.copy()
    ...
    for obj_index in range(len(filtered_objects)):
        ...
        timer = time.time()
       # timerold = timer - 2
        if (timer - timerold) > 0.5:
            crop_img = source_image[box_top: box_bottom, box_left: box_right]
            imagename = "/home/pi/Desktop/ESAP9/yolo/task7_background/" + str(count) +".png"
            count = count + 1
...
def main():
    ...
    while True:
       # timerold = timer - 2
        ...
        input_image[:] = ((input_image[:])*(200.0/255.0)) # TODO: Scale values between 0 and 255
